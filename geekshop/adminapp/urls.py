...
urlpatterns = [
    ...
    path('user_order_update/<int:pk>/', adminapp.user_order_update, name='user_order_update'),
    path('adminapp:user_order_status_change/<str:status>/<int:pk>/', adminapp.user_order_status_change, name='user_order_status_change'),
]
