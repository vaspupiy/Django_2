...
class ProductsTestCase(TestCase):
    def setUp(self):
        ...
        self.product_1 = Product.objects.create(name="стул 1", category=category, price=1022.2, quantity=150)
        self.product_2 = Product.objects.create(name="стул 2", category=category, price=1322.2, quantity=10,
                                                is_active=False)
        self.product_3 = Product.objects.create(name="стул 3", category=category, price=422.2, quantity=120)
    ...
    def test_product_get_item(self):
        product_1 = Product.objects.get(name="стул 1")
